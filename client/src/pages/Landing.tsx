      ...
      <nav className="relative z-20 border-b border-white/[0.06] backdrop-blur-xl bg-background/70 sticky top-0" data-testid="nav-landing">
        <div className="container mx-auto px-4 md:px-6 py-3 flex justify-between items-center">
          <div className="flex items-center cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
            <img src={dgbLogo} alt="DAGRABA Studio" className="h-10 sm:h-12 object-contain drop-shadow-[0_0_15px_rgba(255,20,147,0.3)]" data-testid="img-landing-logo" />
          </div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8">
            <div className="col-span-2 md:col-span-1">
              <div className="mb-4">
                <img src={dgbLogo} alt="DAGRABA Studio" className="h-10 object-contain drop-shadow-[0_0_12px_rgba(255,20,147,0.25)]" data-testid="img-footer-logo" />
              </div>
